...
$STASHCP -d osdf:///ospool/uc-shared/project/muoncollider/tutorial2024/photonGun_E_250_1000/photonGun_E_250_1000_reco_0.slcio ./photonGun_E_250_1000_reco_0.slcio
ls -ltrh
